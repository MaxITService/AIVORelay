...
pub(crate) const RECORDING_OVERLAY_DECAPITALIZE_INDICATOR_MIN_FONT_SIZE_PX: u8 = 6;
pub(crate) const RECORDING_OVERLAY_DECAPITALIZE_INDICATOR_MAX_FONT_SIZE_PX: u8 = 48;
...
fn clamp_soniox_live_preview_sliding_lm_tail_words(value: u16) -> u16 {
    value.clamp(
        SONIOX_LIVE_PREVIEW_SLIDING_LM_MIN_TAIL_WORDS,
        SONIOX_LIVE_PREVIEW_SLIDING_LM_MAX_TAIL_WORDS,
    )
}
...
#[tauri::command]
#[specta::specta]
pub fn change_soniox_live_preview_sliding_lm_window_enabled_setting(
    app: AppHandle,
    enabled: bool,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.soniox_live_preview_sliding_lm_window_enabled = enabled;
    settings::write_settings(&app, settings);
    refresh_soniox_live_preview_window(&app);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_soniox_live_preview_sliding_lm_window_prompt_setting(
    app: AppHandle,
    prompt: String,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.soniox_live_preview_sliding_lm_window_prompt = prompt;
    settings::write_settings(&app, settings);
    refresh_soniox_live_preview_window(&app);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_soniox_live_preview_sliding_lm_window_tail_words_setting(
    app: AppHandle,
    tail_words: u16,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.soniox_live_preview_sliding_lm_window_tail_words =
        clamp_soniox_live_preview_sliding_lm_tail_words(tail_words);
    settings::write_settings(&app, settings);
    refresh_soniox_live_preview_window(&app);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_openai_realtime_whisper_delay_setting(
    app: AppHandle,
    delay: settings::OpenAiRealtimeWhisperDelay,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.openai_realtime_whisper_delay = delay;
    settings::write_settings(&app, settings);
    Ok(())
}
...
pub fn change_openai_realtime_whisper_flatten_enabled_setting(
    ...
    let mut settings = settings::get_settings(&app);
    settings.openai_realtime_whisper_flatten_enabled = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
pub fn change_dictation_quick_tap_threshold_setting(app: AppHandle, value_ms: u32) -> Result<(), String> {
    ...
    let mut settings = settings::get_settings(&app);
    settings.dictation_quick_tap_threshold_ms = value_ms;
    settings::write_settings_checked(&app, settings)
}
