...
Audit note (2026-04-01):
- Current fetched `upstream/main` head checked locally: `4609db7f`.
- Safe review cursor for the next `upstream -> main` intake: `4609db7f`.
...
- Re-triaged corridor up to `4609db7f`: taken/logged `4609db7f`, `d1d33932`, `557d274d`, `17277cf6`, `58cda3f3`, `e35f0a71`, `cb32d35b`, `0b3322fa`, `e1a484f7`, `5a3e6e33`; already covered `095f4ac4`; skipped `8836d455`, `1a95c9c4`, `cd3ec3ab`, `c5ec92b3`, `e3c9f581`, `075a5887`, `012e0666`, `d33535cf`; treated `a3015026` as separate research / split adaptation, not a normal intake row.
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-04-01 | 2026-04-01 | `4609db7f` | add cohere (#1200) | `1027135c` | feat(transcription): port upstream Cohere support | partial port; kept existing dirty bindings untouched |
