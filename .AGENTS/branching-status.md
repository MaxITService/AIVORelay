...
Last synced commit from `main`: `0efb3f7` — fix: dropdown opens upward when at bottom of group; menu widens to fit long options.
...
Last synced commit from `main`: `6029d1e` — feat: show file transcription benchmark time.
