...
async changeNeverLaunchWebviewSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_never_launch_webview_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeRecordingOverlayEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeRecordingOverlayStatusIconColorSetting(color: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_status_icon_color_setting", { color }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeRecordingOverlayCancelIconColorSetting(color: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_cancel_icon_color_setting", { color }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeRecordingOverlayDecapitalizeIndicatorModeSetting(mode: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_decapitalize_indicator_mode_setting", { mode }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeRecordingOverlayDecapitalizeIndicatorCustomTextSetting(text: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_decapitalize_indicator_custom_text_setting", { text }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeRecordingOverlayDecapitalizeIndicatorFontFamilySetting(fontFamily: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_decapitalize_indicator_font_family_setting", { fontFamily }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeRecordingOverlayDecapitalizeIndicatorFontSizeSetting(sizePx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_decapitalize_indicator_font_size_setting", { sizePx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeRecordingOverlayDecapitalizeIndicatorColorSetting(color: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_recording_overlay_decapitalize_indicator_color_setting", { color }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeLocalPreviewAutoFlushEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_local_preview_auto_flush_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeLocalPreviewAutoFlushIntervalSetting(intervalMs: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_local_preview_auto_flush_interval_setting", { intervalMs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeLocalPreviewAutoFlushOverlapSetting(overlapMs: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_local_preview_auto_flush_overlap_setting", { overlapMs }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewSlidingLmWindowEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_sliding_lm_window_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewSlidingLmWindowPromptSetting(prompt: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_sliding_lm_window_prompt_setting", { prompt }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewSlidingLmWindowTailWordsSetting(tailWords: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_sliding_lm_window_tail_words_setting", { tailWords }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewPositionSetting(position: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_position_setting", { position }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewCustomXSetting(xPx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_custom_x_setting", { xPx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewCustomYSetting(yPx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_custom_y_setting", { yPx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewCursorOffsetSetting(distancePx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_cursor_offset_setting", { distancePx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewSizeSetting(size: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_size_setting", { size }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewCustomWidthSetting(widthPx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_custom_width_setting", { widthPx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewCustomHeightSetting(heightPx: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_custom_height_setting", { heightPx }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewThemeSetting(theme: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_theme_setting", { theme }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewOpacitySetting(opacityPercent: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_opacity_setting", { opacityPercent }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewFontColorSetting(color: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_font_color_setting", { color }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewInterimFontColorSetting(color: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_interim_font_color_setting", { color }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewAccentColorSetting(color: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_accent_color_setting", { color }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeSonioxLivePreviewInterimOpacitySetting(opacityPercent: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_live_preview_interim_opacity_setting", { opacityPercent }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeOpenaiRealtimeWhisperDelaySetting(delay: OpenAiRealtimeWhisperDelay) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_openai_realtime_whisper_delay_setting", { delay }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeGeminiLanguageCodeSetting(language: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_gemini_language_code_setting", { language }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeGeminiCustomVocabularySetting(terms: string[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_gemini_custom_vocabulary_setting", { terms }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeGeminiLiveModeSetting(mode: GeminiTranscriptionMode) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_gemini_live_mode_setting", { mode }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeGeminiFileDiarizationSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_gemini_file_diarization_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeSonioxEndpointSensitivitySetting(sensitivity: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_endpoint_sensitivity_setting", { sensitivity }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeSonioxOptimizeDeliveryPreconnectEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_soniox_optimize_delivery_preconnect_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changePostProcessBenchmarkCollapsedSetting(collapsed: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_benchmark_collapsed_setting", { collapsed }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessBenchmarkSystemPromptSetting(prompt: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_benchmark_system_prompt_setting", { prompt }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessBenchmarkUserMessageSetting(message: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_benchmark_user_message_setting", { message }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessBenchmarkLogSetting(log: LlmPostProcessBenchmarkResult[]) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_benchmark_log_setting", { log }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changePostProcessBenchmarkUseSelectedPromptSetting(useSelectedPrompt: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_post_process_benchmark_use_selected_prompt_setting", { useSelectedPrompt }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeFirstStartWizardSkippedSetting(skipped: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_first_start_wizard_skipped_setting", { skipped }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async getDevConsoleLogLevel() : Promise<LogLevel> {
    return await TAURI_INVOKE("get_dev_console_log_level");
},
/**
 * Debug-build-only, process-local console filter. It resets to Info when the
 * debug process restarts.
 */
async setDevConsoleLogLevel(level: LogLevel) : Promise<void> {
    await TAURI_INVOKE("set_dev_console_log_level", { level });
},
async changeDictationStatsEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_dictation_stats_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async resetDictationCharacterCount() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("reset_dictation_character_count") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async ttsLlmHasApiKey(providerId: string) : Promise<Result<boolean, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("tts_llm_has_api_key", { providerId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async ttsLlmSetApiKey(providerId: string, apiKey: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("tts_llm_set_api_key", { providerId, apiKey }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async ttsLlmClearApiKey(providerId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("tts_llm_clear_api_key", { providerId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async fetchTtsLlmModels() : Promise<Result<string[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("fetch_tts_llm_models") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runTtsLlmBenchmark(scope: TtsLlmScope) : Promise<Result<LlmPostProcessBenchmarkResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("run_tts_llm_benchmark", { scope }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async changeMicrophoneInputBoostForDeviceSetting(deviceName: string, db: number) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_microphone_input_boost_for_device_setting", { deviceName, db }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async changeMicrophoneNoiseCancellationEnabledSetting(enabled: boolean) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("change_microphone_noise_cancellation_enabled_setting", { enabled }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async deleteAllHistoryEntries() : Promise<Result<number, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("delete_all_history_entries") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async runLlmPostProcessBenchmark(systemPrompt: string, userMessage: string) : Promise<Result<LlmPostProcessBenchmarkResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("run_llm_post_process_benchmark", { systemPrompt, userMessage }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async retryLastRemoteTranscription() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("retry_last_remote_transcription") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async previewSonioxLivePreviewWindow() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("preview_soniox_live_preview_window") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async closeSonioxLivePreviewDemoWindow() : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("close_soniox_live_preview_demo_window") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
export type AppSettings = { bindings: Partial<{ [key in string]: ShortcutBinding }>; push_to_talk: boolean; auto_shortcut_activation?: boolean; preview_output_only_enabled?: boolean; audio_feedback: boolean; result_ready_audio_feedback?: boolean; audio_feedback_volume?: number; sound_theme?: SoundTheme; start_hidden?: boolean; first_start_wizard_skipped?: boolean; never_launch_webview?: boolean; show_speech_only_mode_in_tray?: boolean; autostart_enabled?: boolean; autostart_as_admin_enabled?: boolean; show_tray_icon?: boolean; show_tray_shortcut_guide?: boolean; show_tray_shortcut_guide_in_main_menu?: boolean; tray_icon_blinking_enabled?: boolean; tray_icon_blink_on_recording?: boolean; tray_icon_blink_on_processing?: boolean; tray_icon_blink_frequency_hz?: number; update_checks_enabled?: boolean; selected_model?: string; transcription_provider?: TranscriptionProvider; remote_stt?: RemoteSttSettings;
/**
 ...
 */
selected_channel?: number | null; last_manual_microphone?: string | null; selected_microphone_auto_switch_enabled?: boolean; selected_microphone_name_pattern?: string; clamshell_microphone?: string | null;
/**
...
export type DiarizedTranscriptProvider = "deepgram" | "soniox" | "gemini"
...
export type TtsBatchFilePlan = { inputPath: string; relativePath: string; outputPath: string; sourceCharacters: number; scanError: string | null }
...
export type TtsBatchProgress = { clientId: string; batchId: string; total: number; finished: number; completed: number; skipped: number; failed: number; cancelled: boolean; done: boolean; startedAtMs: number; workStartedAtMs: number | null; message: string | null; file: TtsBatchFileResult | null }
...
export type TtsLlmPreprocessingSettings = { interactive_enabled?: boolean; file_enabled?: boolean; provider_id?: string; model?: string; key_source?: TtsKeySource; custom_base_url?: string; custom_allow_insecure_http?: boolean; reasoning_enabled?: boolean; reasoning_budget?: number; chunk_target_chars?: number; retry_count?: number; retry_base_delay_ms?: number; request_timeout_seconds?: number; interactive_prompts?: LLMPrompt[]; interactive_selected_prompt_id?: string; file_prompts?: LLMPrompt[]; file_selected_prompt_id?: string; section_collapsed?: boolean; benchmark_collapsed?: boolean; interactive_benchmark_text?: string; file_benchmark_text?: string; interactive_benchmark_log?: LlmPostProcessBenchmarkResult[]; file_benchmark_log?: LlmPostProcessBenchmarkResult[] }
