...
const HELP_SEARCH_RECORDS: readonly HelpSearchRecord[] = [
  ...
  },
  {
    ...
    summary: "Select text and press its shortcut. A voice reads the text aloud.",
    destination: "Speak selected text",
    keywords: ["text to speech", "TTS", "read aloud", "voice", "clipboard"],
  },
  {
    anchor: "help-text-file-to-mp3",
    title: "Choose text files. Get MP3 or WAV audio.",
    summary: "Choose a text or Markdown file. AivoRelay creates MP3 or WAV audio.",
    destination: "Text file to mp3",
    keywords: ["text file", "Markdown", "MP3", "WAV", "audio", "convert"],
  },
  {
