  ...
  return (
    <div className="max-w-3xl w-full mx-auto space-y-6">
      ...
      <SettingsGroup title={t("settings.about.acknowledgments.title")}>
        ...
        <SettingContainer
          title={t("settings.about.acknowledgments.cpal.title")}
          description={t("settings.about.acknowledgments.cpal.description")}
          grouped={true}
          layout="stacked"
        >
          <div className="text-sm text-mid-gray">
            {t("settings.about.acknowledgments.cpal.details")}
          </div>
        </SettingContainer>
        <SettingContainer
          title={t("settings.about.acknowledgments.nnnoiseless.title")}
          description={t(
            "settings.about.acknowledgments.nnnoiseless.description",
          )}
          grouped={true}
          layout="stacked"
        >
          <div className="text-sm text-mid-gray">
            {t("settings.about.acknowledgments.nnnoiseless.details")}
          </div>
        </SettingContainer>
        <SettingContainer
