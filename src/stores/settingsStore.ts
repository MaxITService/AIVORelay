...
const settingUpdaters: {
  ...
  show_speech_only_mode_in_tray: (value) =>
    commands.changeShowSpeechOnlyModeInTraySetting(value as boolean),
  ...
  auto_shortcut_activation: (value) =>
    commands.changeAutoShortcutActivationSetting(value as boolean),
...
(settingUpdaters as any).tts = (value: any) =>
  invoke("update_tts_settings", { settings: value });
...
(settingUpdaters as any).dictation_quick_tap_threshold_ms = (value: any) =>
  invoke("change_dictation_quick_tap_threshold_setting", {
    valueMs: Math.round(Number(value)),
  });
