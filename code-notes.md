...
| `src-tauri/src/managers/soniox_stt.rs`         | Soniox non-live/async transcription manager: request payload construction, cancellation tracking, language handling, and async file transcription calls.                                                                                                                                                                                                    |
...
| `src-tauri/src/commands/file_transcription.rs` | Soniox async integration for file transcription: provider routing, model auto-switch to async endpoint, and optional Soniox overrides. |
