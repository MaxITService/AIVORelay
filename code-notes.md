...
| `src/components/settings/user-interface/UserInterfaceSettings.tsx`       | Added Soniox live preview controls in User Interface settings (enable/disable, fixed/dynamic position, cursor distance, size, theme, transparency, font/accent colors, interim-text opacity) plus expandable help blocks. |
