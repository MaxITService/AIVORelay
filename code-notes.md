...
| `src/components/onboarding/Onboarding.tsx` | Includes Remote STT option support, welcome screen with interactive shortcut selector (HandyShortcut), Soniox recommendation in Remote wizard, and "change provider later" note.             |
